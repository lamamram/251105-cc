---
allowed-tools: Bash(git add:*), Bash(git status:*), Bash(git commit:*), Bash(cd:*)
description: Create a git commit
argument-hint: [--amend] [--no-edit]
---
...
2. Generate 3 commit message candidates based on the changes UNLESS argument `--no-edit` is provided
...
5. Execute git commit with $ARGUMENTS using the selected commit message
